...
#. Template directories in ``django_genie_TEMPLATES`` environment variable. The directories are separated
   by a colon char (``:``). For example: ``django_genie_TEMPLATES=/path/templates/``.
#. Templates from the folder ``.dcg_templates/`` in the current directory.
#. Template directories from ``django_genie_TEMPLATES = []`` list in your Django settings.
#. Templates from folder ``.dcg_templates/`` in ``manage.py`` directory.
#. Templates from ``~/.config/dcg_templates/`` directory.
#. Templates from django_genie project
...
* **models**: a list of the models in the app. See :class:`django_genie.models.Models` class. The listing
  contains :class:`django_genie.models.Model` instances.
...
at the beginning of the template ``{% load generator_tags %}``.


Examples
--------

.. literalinclude:: ../django_genie/templates/admin/admin/__init__.py
   :language: django
   :linenos:
   :caption: admin/__init__.py

.. literalinclude:: ../django_genie/templates/api/api/__init__.py
   :language: django
   :linenos:
   :caption: api/__init__.py

.. literalinclude:: ../django_genie/templates/api/api/serializers.py
   :language: django
   :linenos:
   :caption: api/serializers.py

.. literalinclude:: ../django_genie/templates/api/api/viewsets.py
   :language: django
   :linenos:
